...
func newRubaOrganizations(rootSDK *Ruba, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *RubaOrganizations {
	return &RubaOrganizations{
		rootSDK:          rootSDK,
...
func (s *RubaOrganizations) Get(ctx context.Context, slug string, opts ...operations.Option) (*operations.CustomerPortalOrganizationsGetResponse, error) {
