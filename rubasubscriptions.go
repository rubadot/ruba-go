...
func newRubaSubscriptions(rootSDK *Ruba, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *RubaSubscriptions {
	return &RubaSubscriptions{
		rootSDK:          rootSDK,
...
func (s *RubaSubscriptions) List(ctx context.Context, request operations.CustomerPortalSubscriptionsListRequest, security operations.CustomerPortalSubscriptionsListSecurity, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsListResponse, error) {
...
//
// **Scopes**: `customer_portal:read` `customer_portal:write`
func (s *RubaSubscriptions) Get(ctx context.Context, security operations.CustomerPortalSubscriptionsGetSecurity, id string, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsGetResponse, error) {
...
func (s *RubaSubscriptions) Cancel(ctx context.Context, security operations.CustomerPortalSubscriptionsCancelSecurity, id string, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsCancelResponse, error) {
...
func (s *RubaSubscriptions) Update(ctx context.Context, security operations.CustomerPortalSubscriptionsUpdateSecurity, id string, customerSubscriptionUpdate components.CustomerSubscriptionUpdate, opts ...operations.Option) (*operations.CustomerPortalSubscriptionsUpdateResponse, error) {
