...
func main() {
    ...
    res, err := s.Customers.List(ctx, operations.CustomersListRequest{
        OrganizationID: rubago.Pointer(operations.CreateCustomersListQueryParamOrganizationIDFilterStr(
...
func main() {
    ...
    res, err := s.Customers.Export(ctx, rubago.Pointer(operations.CreateCustomersExportQueryParamOrganizationIDStr(
        "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
    )))
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Customers.Delete(ctx, "<value>", rubago.Pointer(false))
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Customers.Update(ctx, "<value>", components.CustomerUpdate{
        Email: rubago.Pointer("customer@example.com"),
        Name: rubago.Pointer("John Doe"),
        BillingAddress: &components.AddressInput{
            Country: components.AddressInputCountryAlpha2InputUs,
        },
...
func main() {
    ...
    res, err := s.Customers.DeleteExternal(ctx, "<id>", rubago.Pointer(false))
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
