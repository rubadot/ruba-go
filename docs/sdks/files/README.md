...
func main() {
    ...
    res, err := s.Files.List(ctx, rubago.Pointer(operations.CreateFilesListQueryParamOrganizationIDFilterStr(
        "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
    )), nil, rubago.Pointer[int64](1), rubago.Pointer[int64](10))
    if err != nil {
        log.Fatal(err)
    }
    ...
    res, err := s.Files.Uploaded(ctx, "<value>", components.FileUploadCompleted{
        ...
        Parts: []components.S3FileUploadCompletedPart{
            components.S3FileUploadCompletedPart{
                Number: 979613,
                ChecksumEtag: "<value>",
                ChecksumSha256Base64: rubago.Pointer("<value>"),
            },
            components.S3FileUploadCompletedPart{
                Number: 979613,
                ChecksumEtag: "<value>",
