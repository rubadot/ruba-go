...
func main() {
    ...
    res, err := s.OrganizationAccessTokens.List(ctx, rubago.Pointer(operations.CreateOrganizationAccessTokensListQueryParamOrganizationIDFilterStr(
        "1dbfc517-0bbf-4301-9ba8-555ca42b9737",
    )), rubago.Pointer[int64](1), rubago.Pointer[int64](10), nil)
    if err != nil {
        log.Fatal(err)
    }
